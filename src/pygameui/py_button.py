...
class ToggleButton(Button):
    ...
    def __init__(self, text, center, size, font, on_changed=_do_nothing, on_click_values = ()):
        def toggle():
            self.toggled = not self.toggled
            on_changed(self.toggled)

        self.on_changed = on_changed
        super().__init__(text, center, size, font, toggle,on_click_values=on_click_values)
